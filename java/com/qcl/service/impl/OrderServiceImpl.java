...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderDTO cancel(OrderDTO orderDTO) {
        ...
        if (CollectionUtils.isEmpty(orderDTO.getOrderDetailList())) {
            log.error("[cancel order] there are no details of the goods in the order, orderDTO={}", orderDTO);
    ...
    public OrderDTO finish(OrderDTO orderDTO) {
        ...
        if (orderDTO.getOrderStatus().equals(OrderStatusEnum.NEW.getCode())) {
            log.error("Closed order order status is not correct, orderId={}, orderStatus={}", orderDTO.getOrderId(), orderDTO.getOrderStatus());
